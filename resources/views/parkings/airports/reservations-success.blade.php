...
<section class="success-section pt-5">
  <div class="success-container">
    ...
    <div>
      <h1 class="pt-3">Thank you for the reservation!</h1>
      @if(session('reservation_data_for_success_page'))
      ...
      <div class="pt-3 d-flex flex-column align-items-center justify-content-center">
       <div class="reservation-details">
         <p><strong>Name:</strong> {{ session('reservation_data_for_success_page')['name'] }}</p>
         <p><strong>Phone:</strong> {{ session('reservation_data_for_success_page')['phone'] }}</p>
         <p><strong>Email:</strong> {{ session('reservation_data_for_success_page')['email'] }}</p>
         <p><strong>Car Number:</strong> {{ session('reservation_data_for_success_page')['car_number'] }}</p>
         <p><strong>Car Model:</strong> {{ session('reservation_data_for_success_page')['car_model'] }}</p>
         <p><strong>Car Color:</strong> {{ session('reservation_data_for_success_page')['car_color'] }}</p>
         <p><strong>Payment Method:</strong> {{ session('reservation_data_for_success_page')['payment_method'] }}</p>
       </div>
     </div>  
     @endif
     <div class="pt-3">
